...
Use Internal Agent as an AI Execution Agent under AI-CDAD.

## Best For

corporate controlled workflows, internal tool integrations, MCP-enabled automations and custom agents.
