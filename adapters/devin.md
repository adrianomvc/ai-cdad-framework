...
Use Devin as an AI Execution Agent under AI-CDAD.

## Best For

autonomous repository work, long-running implementation, PR preparation, code investigation, multi-file changes.
